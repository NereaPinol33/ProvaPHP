...
<main class="flex-grow p-4 sm:p-8">
    <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6" style="background: #f28e1c70 ">
        <h2 class="text-4xl sm:text-7xl font-bold mb-6 sm:mb-8 text-center uppercase tracking-wide text-shadow">
            <span class="spooky-font text-shadow" style="background-color: transparent; color: #ff9419;">Eliminar película</span>
        </h2>
            <p class="font-serif text-shadow text-xl" class=" mb-4" style="color: #d4abfa">¿Quieres eliminar la película "<?= htmlspecialchars($film->titulo) ?>"?</p>
        <form action="/peliculas/destroy" method="POST" class="mt-4">
